...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.concept_only'
        db.add_column('runs_game', 'concept_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.concept_only'
        db.delete_column('runs_game', 'concept_only')
    ...
    models = {
        ...
        'runs.game': {
            ...
            'concept_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
