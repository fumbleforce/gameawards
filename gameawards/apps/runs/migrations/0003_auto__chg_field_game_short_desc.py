...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.short_desc'
        db.alter_column('runs_game', 'short_desc', self.gf('django.db.models.fields.TextField')(max_length=170, null=True))

    def backwards(self, orm):

        # Changing field 'Game.short_desc'
        db.alter_column('runs_game', 'short_desc', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))
    ...
    models = {
        ...
        'runs.game': {
            ...
            'short_desc': ('django.db.models.fields.TextField', [], {'max_length': '170', 'null': 'True', 'blank': 'True'}),
