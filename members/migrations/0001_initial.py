...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('members', ['Team'])

        # Adding M2M table for field devs on 'Team'
        db.create_table('members_team_devs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['members.team'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('members_team_devs', ['team_id', 'user_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'Team'
        db.delete_table('members_team')

        # Removing M2M table for field devs on 'Team'
        db.delete_table('members_team_devs')
